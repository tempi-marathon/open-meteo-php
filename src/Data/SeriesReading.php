 ...
 * @property-read ?float $apparentTemperature
 * @property-read ?float $windSpeed10m
 * @property-read ?WindDirection $windDirection10m
 * @property-read ?WindDirection $windDirection80m
 * @property-read ?WeatherCode $weatherCode
 * @property-read ?float $precipitation
 * @property-read ?bool $isDay
 */
readonly class SeriesReading
{
    /**
